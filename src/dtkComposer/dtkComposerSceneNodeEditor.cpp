 ...
 * Version: $Id$
 * Last-Updated: Wed Mar 21 09:24:09 2012 (+0100)
 *           By: tkloczko
 *     Update #: 756
 */
...
// /////////////////////////////////////////////////////////////////
    ...
    if (command_incr_i) {
        ...
        dynamic_cast<dtkComposerNodeControl *>(control->wrapee())->appendOutputTwin(dynamic_cast<dtkComposerTransmitterVariant *>(control->block("Increment")->wrapee()->emitters().last()));
