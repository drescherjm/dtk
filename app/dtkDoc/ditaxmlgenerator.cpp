                                   ...
                                   CodeMarker *marker)
{
    ...
    case Atom::GeneratedList:
        if (atom->string() == "annotatedclasses") {
            ...
            generateCompactList(Generic, relative, qdb_->getCppClasses(), true, QStringLiteral("dtk"));
        }
            ...
            // mws 03/10/2013
            generateCompactList(Generic, relative, qdb_->getCompatibilityClasses(), false, QStringLiteral("dtk"));
        }
        else if (atom->string() == "obsoleteclasses") {
            generateCompactList(Generic, relative, qdb_->getObsoleteClasses(), false, QStringLiteral("dtk"));
        }
            ...
            generateCompactList(Obsolete, relative, qdb_->getClassesWithObsoleteMembers(), false, QStringLiteral("dtk"));
        }
            ...
            // mws 03/10/2013
            generateCompactList(Generic, relative, qdb_->getMainClasses(), true, QStringLiteral("dtk"));
        }
        else if (atom->string() == "services") {
            // "services" is no longer used. Delete this at some point.
            // mws 03/10/2013
            generateCompactList(Generic, relative, qdb_->getServiceClasses(), false, QStringLiteral("dtk"));
        }
