...
class  dtkComposerNodeVector3DOperatorUnary : public dtkComposerNodeLeaf
{
public:
...
class  dtkComposerNodeVector3DOperatorUnaryScalar : public dtkComposerNodeLeaf
{
public:
...
class  dtkComposerNodeVector3DOperatorUnaryUnitary : public dtkComposerNodeVector3DOperatorUnary
{
public:
    void run(void);
...
class  dtkComposerNodeVector3DOperatorUnaryScalarNorm : public dtkComposerNodeVector3DOperatorUnaryScalar
{
public:
    void run(void);
