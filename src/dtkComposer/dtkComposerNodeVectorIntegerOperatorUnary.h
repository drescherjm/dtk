...
class  dtkComposerNodeVectorIntegerOperatorUnary : public dtkComposerNodeLeaf
{
public:
...
class  dtkComposerNodeVectorIntegerOperatorUnaryScalar : public dtkComposerNodeLeaf
{
public:
...
class  dtkComposerNodeVectorIntegerOperatorUnaryUnitary : public dtkComposerNodeVectorIntegerOperatorUnary
{
public:
    void run(void);
...
class  dtkComposerNodeVectorIntegerOperatorUnaryScalarNorm : public dtkComposerNodeVectorIntegerOperatorUnaryScalar
{
public:
    void run(void);
