 ...
 * Version: $Id$
 * Last-Updated: Thu Sep  8 10:32:19 2011 (+0200)
 *           By: jwintz
 *     Update #: 147
 */
...
// /////////////////////////////////////////////////////////////////
        ...
        for(int slave = 1; slave < size; slave++) {
            ...
            MPI::COMM_WORLD.Recv(&partial_sum, 1, MPI_LONG, MPI_ANY_SOURCE, RECV_TAG, status);

            qDebug() << "Rank" << status.Get_source() << "has partial sum" << partial_sum;
