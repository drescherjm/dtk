 ...
 * Version: $Id$
 * Last-Updated: 2013 Wed Jan  9 09:54:39 (+0100)
 *           By: Thibaud Kloczko
 *     Update #: 104
 */
...
void dtkComposerNodeVectorRealOperatorModifierSet::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_index.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierSet::" << Q_FUNC_INFO << "Input vector not set. Nothing is done";
            d->emitter_vector.clearData();
            return;
        }

        if (index >= vector->size()) {
            dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierSet::" << Q_FUNC_INFO << "index > size of the vector. Same array is returned.";
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierSet::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierSum::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_index.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierSum::" << Q_FUNC_INFO << "Input vector not set. Nothing is done";
            d->emitter_vector.clearData();
            return;
        }

        if (index >= vector->size()) {
            dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierSum::" << Q_FUNC_INFO << "index > size of the vector. Same array is returned.";
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierSum::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
// /////////////////////////////////////////////////////////////////
...
void dtkComposerNodeVectorRealOperatorModifierSubstract::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_index.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierSubstract::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }

        if (index >= vector->size()) {
            dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierSubstract::" << Q_FUNC_INFO << "index > size of the vector. Same array is returned.";
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierSubstract::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierMult::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_index.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierMult::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }

        if (index >= vector->size()) {
            dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierMult::" << Q_FUNC_INFO << "index > size of the vector. Same array is returned.";
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierMult::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierDivide::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_index.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierDivide::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }

        if (index >= vector->size()) {
            dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierDivide::" << Q_FUNC_INFO << "index > size of the vector. Same array is returned.";

        } else {
            if (value == 0)
                dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierDivide::" << Q_FUNC_INFO << "Value is zero. Same array is returned." ;
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierDivide::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierAllAdd::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierAllAdd::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierAllAdd::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierAllSubstract::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierAllSubstract::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierAllSubstract::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierAllMult::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierAllMult::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierAllMult::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierAllDivide::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_value.isEmpty() ) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierAllDivide::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }

        if (value == 0) {
            dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierAllDivide::" << Q_FUNC_INFO << "Value is zero. Same array is returned." ;
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierAllDivide::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierPartSum::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_subvector.isEmpty()) {
        ...
        dtkVectorReal *vector = d->receiver_vector.data();
        const dtkVectorReal *subvector = d->receiver_subvector.constData();

        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierPartSum::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }

        if (!subvector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierPartSum::" << Q_FUNC_INFO << "Subvector is not defined.";
            d->emitter_vector.clearData();
            return;
        }
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierPartSum::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
...
void dtkComposerNodeVectorRealOperatorModifierPartSubstract::run(void)
{
    if (!d->receiver_vector.isEmpty() && !d->receiver_subvector.isEmpty()) {
        ...
        if (!vector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierPartSubstract::" << Q_FUNC_INFO << "Vector is not defined.";
            d->emitter_vector.clearData();
            return;
        }

        if (!subvector) {
            dtkError() << "dtkComposerNodeVectorRealOperatorModifierPartSubstract::" << Q_FUNC_INFO << "Subvector is not defined.";
            d->emitter_vector.clearData();
            return;
        }
        ...
        dtkWarn() << "dtkComposerNodeVectorRealOperatorModifierPartSubstract::" << Q_FUNC_INFO << "Inputs not specified. Nothing is done";
        d->emitter_vector.clearData();
    }
}
