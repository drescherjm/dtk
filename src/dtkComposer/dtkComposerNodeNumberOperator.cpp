 ...
 * Version: $Id$
 * Last-Updated: Sun Mar  4 23:26:10 2012 (+0100)
 *           By: tkloczko
 *     Update #: 137
 */
...
{
    qlonglong a = d->receiver_lhs->dataToLongLong();
    qlonglong b = d->receiver_rhs->dataToLongLong();
...
{
    qreal a = d->receiver_lhs->dataToReal();
    qreal b = d->receiver_rhs->dataToReal();
