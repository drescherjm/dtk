...
public:
    virtual ~dtkSparseMatrix(void) { if (m_handler) delete m_handler; m_handler = 0; }
...
public:
    ...
    public:
        inline item& operator =  (const T& value) { h->setValue(id, value);                return *this; }
        inline item& operator += (const T& value) { h->setValue(id, h->value(id) + value); return *this; }
        inline item& operator -= (const T& value) { h->setValue(id, h->value(id) - value); return *this; }
        inline item& operator *= (const T& value) { h->setValue(id, h->value(id) * value); return *this; }
        inline item& operator /= (const T& value) { h->setValue(id, h->value(id) / value); return *this; }
...
public:
    ...
    public:
        inline iterator& operator = (const iterator& o) { it = o.it; return *this; }
    ...
    public:
        ...
        inline QPair<qlonglong, qlonglong> coordinates(void) const { return it.h->coordinates(it.id); }
    ...
    public:
        inline iterator& operator ++ (void) { ++(it.id); return *this; }
        inline iterator  operator ++ (int)  { ++(it.id); return iterator(it.h, it.id-1); }
        inline iterator& operator -- (void) { --(it.id); return *this; }
        inline iterator  operator -- (int)  { --(it.id); return iterator(it.h, it.id+1); }
...
public:
    ...
    public:
        inline const_iterator& operator = (const const_iterator& o) { it = o.it; return *this; }
    ...
    public:
        inline const_iterator& operator ++ (void) { ++(it.id); return *this; }
        inline const_iterator  operator ++ (int)  { ++(it.id); return const_iterator(it.h, it.id-1); }
        inline const_iterator& operator -- (void) { --(it.id); return *this; }
        inline const_iterator  operator -- (int)  { --(it.id); return const_iterator(it.h, it.id+1); }
        inline const_iterator& operator += (qlonglong j) { (it.id) += j; return *this; }
        inline const_iterator& operator -= (qlonglong j) { (it.id) -= j; return *this; }
        inline const_iterator  operator +  (qlonglong j) const { return const_iterator(it.h, it.id + j); }
        inline const_iterator  operator -  (qlonglong j) const { return const_iterator(it.h, it.id - j); }
...
public:
    ...
    inline void resize(qlonglong row_count, qlonglong col_count) { m_handler->resize(row_count, col_count); }
...
public:
    ...
    inline const_iterator        end(void) const { return const_iterator(m_handler, this->nonZeroCount()); }
    inline const_iterator       cend(void) const { return const_iterator(m_handler, this->nonZeroCount()); }
    inline const_iterator   constEnd(void) const { return const_iterator(m_handler, this->nonZeroCount()); }
...
public:
    ...
    inline void setAt(qlonglong i, qlonglong j, const T& value) { m_array[this->pos(i, j)] = value; }
...
public:
    ...
    inline QPair<qlonglong, qlonglong> coordinates(qlonglong pos) const { return qMakePair(this->searchRow(pos, 0, m_row_count -1), m_col_indices.at(pos)); }
...
public:
    ...
    inline void setAt(qlonglong i, qlonglong j, const T& value) { m_map.insert(qMakePair(i, j), value); }
