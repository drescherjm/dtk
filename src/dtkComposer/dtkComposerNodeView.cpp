 ...
 * Version: $Id$
 * Last-Updated: Fri Jul 16 11:57:34 2010 (+0200)
 *           By: Julien Wintz
 *     Update #: 32
 */
...
{
    d->property_input_data = new dtkComposerNodeProperty("if", dtkComposerNodeProperty::Input, dtkComposerNodeProperty::Multiple, this);
