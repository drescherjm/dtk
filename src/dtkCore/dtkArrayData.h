...
public:
          void *data(void)       { return reinterpret_cast<      char *>(this) + offset; }
    const void *data(void) const { return reinterpret_cast<const char *>(this) + offset; }

public:
    bool isMutable(void) const { return alloc != 0; }
...
public:
    ...
    static dtkArrayData *sharedNull(void) { return const_cast<dtkArrayData *>(shared_null); }
};
...
{
public:
          T *data(void)       { return static_cast<      T *>(dtkArrayData::data()); }
    const T *data(void) const { return static_cast<const T *>(dtkArrayData::data()); }
...
public:
    ...
    public:
        ...
        iterator  operator ++ (int) { T *n = i; ++i; return n; }
        iterator& operator -- (void) { i--; return *this; }
        iterator  operator -- (int) { T *n = i; i--; return n; }
        iterator& operator += (qintptr j) { i+=j; return *this; }
        iterator& operator -= (qintptr j) { i-=j; return *this; }
...
public:
    ...
    public:
        ...
        bool operator >  (const const_iterator& other) const { return i >  other.i; }
        bool operator >= (const const_iterator& other) const { return i >= other.i; }
        const_iterator &operator ++ (void) { ++i; return *this; }
        const_iterator operator  ++ (int) { const T *n = i; ++i; return n; }
        const_iterator &operator -- (void) { i--; return *this; }
        const_iterator operator  -- (int) { const T *n = i; i--; return n; }
        const_iterator &operator += (qintptr j) { i+=j; return *this; }
        const_iterator &operator -= (qintptr j) { i-=j; return *this; }
        const_iterator operator  +  (qintptr j) const { return const_iterator(i+j); }
        const_iterator operator  -  (qintptr j) const { return const_iterator(i-j); }
        qintptr      operator  -  (const const_iterator& j) const { return i - j.i; }
