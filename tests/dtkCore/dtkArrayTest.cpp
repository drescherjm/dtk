...
dtkArrayTestObject::dtkArrayTestObject(void)
{
}
...
void dtkArrayTestObject::initTestCase(void)
{

}

void dtkArrayTestObject::init(void)
{

}

void dtkArrayTestObject::cleanup(void)
{

}

void dtkArrayTestObject::cleanupTestCase(void)
{

}

void dtkArrayTestObject::testCreate(void)
{
...
void dtkArrayTestObject::testAppend(void)
{
    dtkArray<double> array;
    int index;
...
void dtkArrayTestObject::testAppendTwoAtATime(void)
{
    int index;
...
void dtkArrayTestObject::testAppendThreeAtATime(void)
{
    int index;
...
void dtkArrayTestObject::testAppendFourAtATime(void)
{
    int index;
...
void dtkArrayTestObject::testAppendArray(void)
{
    dtkArray<double> array;
    dtkArray<double> array2;
    int index;
...
void dtkArrayTestObject::testSetAt(void)
{
    int index;
...
void dtkArrayTestObject::testValue(void)
{
    dtkArray<double> array;
...
void dtkArrayTestObject::testCopy(void)
{
...
void dtkArrayTestObject::testResize(void)
{
    dtkArray<int> array;
...
void dtkArrayTestObject::testReserve(void)
{
    dtkArray<double> array;
    array.reserve(1000);
    QVERIFY(array.isEmpty());
...
void dtkArrayTestObject::testSqueeze(void)
{
    dtkArray<double> array;
    array.reserve(100);
    QVERIFY(array.isEmpty());
...
void dtkArrayTestObject::testCompare(void)
{
    dtkArray<double> array, array2, array3;
...
void dtkArrayTestObject::testRemove(void)
{
    dtkArray<double> array;
...
void dtkArrayTestObject::testRemoveFirstLast(void)
{
    dtkArray<double> array;
...
void dtkArrayTestObject::testExtend(void)
{
    dtkArray<double> array;
...
void dtkArrayTestObject::testReverse(void)
{
...
void dtkArrayTestObject::testReversed(void)
{
    dtkArray<double> array0;
...
void dtkArrayTestObject::testMid(void)
{
    dtkArray<double> array;
...
void dtkArrayTestObject::testLeft(void)
{
    dtkArray<double> array;
    for (int index = 0; index < 1024; ++index)
        array.append(double(index));
...
void dtkArrayTestObject::testRight(void)
{
    dtkArray<double> array;
    for (int index = 0; index < 1024; ++index)
        array.append(double(index));
...
void dtkArrayTestObject::testIterate(void)
{
    dtkArray<double> array;
    for (int index = 0; index < 1024; ++index)
        array.append(double(index));
...
void dtkArrayTestObject::testSearch(void)
{
    dtkArray<double> array;
    for (int index = 0; index < 1000; ++index)
        array.append(double(index));
...
void dtkArrayTestObject::testExceptions(void)
{
#ifndef QT_NO_EXCEPTIONS
...
void dtkArrayTestObject::testDataStream(void)
{
...
DTKTEST_NOGUI_MAIN(dtkArrayTest, dtkArrayTestObject)
