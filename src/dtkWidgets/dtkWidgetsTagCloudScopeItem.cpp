...
dtkWidgetsTagCloudScopeItem::dtkWidgetsTagCloudScopeItem(QWidget *parent) : QWidget(parent), d(new dtkWidgetsTagCloudScopeItemPrivate)
{
    d->width = 100;
    d->height = 24;
    d->offset_min = 10;
    ...
    d->bg->setStyleSheet(
        "border-image: url(:dtkWidgetsTagCloud/dtkWidgetsTagCloudScopeItem-bg.png) 3 10 3 10;"
    ...
    d->fg->setStyleSheet(
        "border-image: url(:dtkWidgetsTagCloud/dtkWidgetsTagCloudScopeItem-fg-light.png) 3 10 3 10;"
        "border-top: 3px transparent;"
        "border-bottom: 3px transparent;"
        "border-right: 10px transparent;"
        "border-left: 10px transparent;");
