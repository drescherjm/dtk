...
class DTKCORE_EXPORT %ClassName%Private : public dtkAbstractDataPrivate
{
public:
    %ClassName%Private(%ClassName% *q = 0) : dtkAbstractDataPrivate(q) {}
    %ClassName%Private(const %ClassName%Private& other) : dtkAbstractDataPrivate(other) {}
...
DTK_IMPLEMENT_PRIVATE(%ClassName%, dtkAbstractData);
