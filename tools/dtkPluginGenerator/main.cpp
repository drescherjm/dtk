 ...
 * Version: $Id$
 * Last-Updated: Thu Jun  4 13:27:00 2009 (+0200)
 *           By: Julien Wintz
 *     Update #: 109
 */
...
int main(int argc, char** argv)
{
    ...
    AnyOption options;
    options.addUsage(QString("Usage: %1 --help | --gui | [--output path --prefix prefixName --suffix suffixName --type typeName").arg(argv[0]).toAscii());
    options.addUsage("");
    options.addUsage("--help                Displays this message.");
    options.addUsage("--gui                 Run the gui version.");
