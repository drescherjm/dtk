 ...
 * Version: 
 * Last-Updated: Mon Jul  1 16:41:12 2013 (+0200)
 *           By: Thibaud Kloczko
 *     Update #: 130
 */
...
public:
    ...
    void setRawData(const T *data, int size, bool isWritable = false);
...
template <typename T, int PreallocSize>
Q_INLINE_TEMPLATE void dtkArray<T, PreallocSize>::setRawData(const T *raw_data, int size, bool isWritable)
{
    Q_ASSERT(size >= 0);
