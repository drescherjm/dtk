...
dtkSettingsEditorVariantDelegate::dtkSettingsEditorVariantDelegate(QObject *parent) : QItemDelegate(parent)
{
...
bool dtkSettingsEditorVariantDelegate::isSupportedType(QVariant::Type type)
{
    switch (type) {
    case QVariant::Bool:
    case QVariant::ByteArray:
...
// /////////////////////////////////////////////////////////////////
// dtkSettingsEditorTree
// /////////////////////////////////////////////////////////////////

dtkSettingsEditorTree::dtkSettingsEditorTree(QWidget *parent) : QTreeWidget(parent)
{
    setItemDelegate(new dtkSettingsEditorVariantDelegate(this));
...
void dtkSettingsEditorTree::setSettingsObject(QSettings *settings)
{
...
QSize dtkSettingsEditorTree::sizeHint(void) const
{
...
void dtkSettingsEditorTree::setFallbacksEnabled(bool enabled)
{
    if (settings) {
...
void dtkSettingsEditorTree::maybeRefresh(void)
{
    if (state() != EditingState)
        refresh();
}

void dtkSettingsEditorTree::refresh(void)
{
    if (!settings)
        return;
...
bool dtkSettingsEditorTree::event(QEvent *event)
{
...
void dtkSettingsEditorTree::updateSetting(QTreeWidgetItem *item)
{
...
void dtkSettingsEditorTree::updateChildItems(QTreeWidgetItem *parent)
{
    int dividerIndex = 0;
...
QTreeWidgetItem *dtkSettingsEditorTree::childAt(QTreeWidgetItem *parent, int index)
{
    if (parent)
...
int dtkSettingsEditorTree::childCount(QTreeWidgetItem *parent)
{
    if (parent)
...
void dtkSettingsEditorTree::moveItemForward(QTreeWidgetItem *parent, int oldIndex, int newIndex)
{
...
dtkSettingsEditor::~dtkSettingsEditor(void)
{
    delete d;
...
void dtkSettingsEditor::setSettings(const QString& organisation, const QString& application)
{
