...
{
    // Initializes dtkComposerMetatypes map
    this->initComposerMetatypes();
...
void dtkComposerFactory::initComposerMetatypes(void)
{
//     dtkComposerTypes->insert(qMetaTypeId<dtkMatrixReal*>(),       dtkMatrixReal_Id);
//     dtkComposerTypes->insert(qMetaTypeId<dtkMatrixInteger*>(), dtkMatrixInteger_Id);
//     dtkComposerTypes->insert(qMetaTypeId<dtkAbstractData*>(),      dtkAbstractData_Id);

// #if defined(DTK_BUILD_PLOT) && defined(DTK_HAVE_PLOT)
//     dtkComposerTypes->insert(qMetaTypeId<dtkPlotCurve*>(), dtkPlotCurve_Id);
// #endif
}

void dtkComposerFactory::initNodeNumberOperatorUnary(void)
{
    // d->nodes << "Abs";
...
dtkComposerMetaTypes *dtkComposerMetaTypes::s_instance = NULL;
