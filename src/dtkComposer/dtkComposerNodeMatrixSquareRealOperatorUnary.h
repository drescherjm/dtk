...
class  dtkComposerNodeMatrixSquareRealOperatorUnary : public dtkComposerNodeLeaf
{
public:
...
class  dtkComposerNodeMatrixSquareRealOperatorUnaryScalar : public dtkComposerNodeLeaf
{
public:
...
class  dtkComposerNodeMatrixSquareRealOperatorUnaryTranspose : public dtkComposerNodeMatrixSquareRealOperatorUnary
{
public:
    void run(void);
...
class  dtkComposerNodeMatrixSquareRealOperatorUnaryInverse: public dtkComposerNodeMatrixSquareRealOperatorUnary
{
public:
    void run(void);
...
class  dtkComposerNodeMatrixSquareRealOperatorUnaryScalarDeterminant : public dtkComposerNodeMatrixSquareRealOperatorUnaryScalar
{
public:
    void run(void);
...
class  dtkComposerNodeMatrixSquareRealOperatorUnaryScalarTrace : public dtkComposerNodeMatrixSquareRealOperatorUnaryScalar
{
public:
    void run(void);
