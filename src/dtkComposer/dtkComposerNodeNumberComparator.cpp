 ...
 * Version: $Id$
 * Last-Updated: Tue Mar 15 14:22:33 2011 (+0100)
 *           By: Thibaud Kloczko
 *     Update #: 44
 */
    ...
    if (genre != dtkComposerNodeNumber::Invalid) {
        ...
        case dtkComposerNodeNumberComparator::LesserThan:
            ...
            case dtkComposerNodeNumber::Float:
                d->value = dtkLesserThanUlps(a.value<float>(), b.value<float>(), (int_least32_t)10);
                break;
            case dtkComposerNodeNumber::Double:
                d->value = dtkLesserThanUlps(a.toDouble(), b.toDouble(), (int_least64_t)10);
                break;
            }
            break;
        ...
        case dtkComposerNodeNumberComparator::LesserThanOrEqual:
            ...
            case dtkComposerNodeNumber::ULongLong:
                ...
                break;
            case dtkComposerNodeNumber::Float:
                d->value = dtkLesserThanOrAlmostEqualUlps(a.value<float>(), b.value<float>(), (int_least32_t)10);
                break;
            case dtkComposerNodeNumber::Double:
                d->value = dtkLesserThanOrAlmostEqualUlps(a.toDouble(), b.toDouble(), (int_least64_t)10);
                break;
            }
            break;
        ...
        case dtkComposerNodeNumberComparator::GreaterThan:
            ...
            case dtkComposerNodeNumber::ULongLong:
                ...
                break;
            case dtkComposerNodeNumber::Float:
                d->value = dtkGreaterThanUlps(a.value<float>(), b.value<float>(), (int_least32_t)10);
                break;
            case dtkComposerNodeNumber::Double:
                d->value = dtkGreaterThanUlps(a.toDouble(), b.toDouble(), (int_least64_t)10);
                break;
            }
            break;
        ...
        case dtkComposerNodeNumberComparator::GreaterThanOrEqual:
            ...
            case dtkComposerNodeNumber::ULongLong:
                ...
                break;
            case dtkComposerNodeNumber::Float:
                d->value = dtkGreaterThanOrAlmostEqualUlps(a.value<float>(), b.value<float>(), (int_least32_t)10);
                break;
            case dtkComposerNodeNumber::Double:
                d->value = dtkGreaterThanOrAlmostEqualUlps(a.toDouble(), b.toDouble(), (int_least64_t)10);
                break;
            }
            break;
        ...
        case dtkComposerNodeNumberComparator::Equal:
            ...
            case dtkComposerNodeNumber::ULongLong:
                ...
                break;
            case dtkComposerNodeNumber::Float:
                d->value = dtkAlmostEqualUlps(a.value<float>(), b.value<float>(), (int_least32_t)10);
                break;
            case dtkComposerNodeNumber::Double:
                d->value = dtkAlmostEqualUlps(a.toDouble(), b.toDouble(), (int_least64_t)10);
                break;
            }
            break;
