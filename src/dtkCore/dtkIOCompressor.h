...
/****************************************************************************
** dtkIOCompressor: this is just a renaming of qtiocompressor.
...
public:
    ...
    dtkIOCompressor(QIODevice *device, int compressionLevel = 6, int bufferSize = 65500);
    ~dtkIOCompressor();
...
private:
    ...
    Q_DECLARE_PRIVATE(dtkIOCompressor)
    Q_DISABLE_COPY(dtkIOCompressor)
};
