...
class dtkSettingsEditorVariantDelegate : public QItemDelegate
{
    Q_OBJECT
...
class dtkSettingsEditorTree : public QTreeWidget
{
    Q_OBJECT

public:
    dtkSettingsEditorTree(QWidget *parent = 0);
