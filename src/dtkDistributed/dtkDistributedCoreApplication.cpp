...
/*!
  ...
  \brief dtkDistributedCoreApplication ...

*/

dtkDistributedCoreApplication::dtkDistributedCoreApplication(int &argc, char **argv): QCoreApplication(argc,argv), dtkDistributedAbstractApplication()
{
};
